...
\begin{longtable}{p{4cm}p{11.5cm}}
   ...
   \textsc{Historischer Fokus}         & Aristoteles, Friedrich Nietzsche\\
                                       & \\
   \textsc{Bevorzugte Werkzeuge}       & \LaTeX, LimeSurvey, Stata, R, Python
\end{longtable}
...
& \footnotesize{Vortrag auf der 5. European Experimental Philosophy Conference; University of East Anglia}\\
\\
