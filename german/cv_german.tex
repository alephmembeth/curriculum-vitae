...
\vfill
\begin{center}
   \fbox{\includegraphics[scale=0.15]{max_4.jpeg}}\\
   {\scriptsize \textcolor{gray}{Illustration: Kris Merola}}
\end{center}
\vfill
...
\begin{longtable}{p{4cm}p{11.5cm}}
   \textsc{Anschrift}   & Carl von Ossietzky Universität Oldenburg\\
                        ...
                        & Deutschland\\
                        & \\
   \textsc{Telefon}     & +49 (0)441 798 2034\\
                        & \\
...
\begin{longtable}{p{4cm}p{11.5cm}}
   \textsc{Spezialisierungsbereiche}   & Experimentelle Philosophie, Bedarfsgerechtigkeit, Kausalität\\
                                       & \\
   \textsc{Kompetenzbereiche}          & Ludologie, Verteilungsgerechtigkeit,\\
                                       & Wissenschaftsphilosophie, Metaphysik\\
                                       & \\
   \textsc{Interessensbereiche}        & Digitale Geisteswissenschaften, Metaphilosophie,\\
                                       & Sprachphilosophie\\
                                       & \\
   \textsc{Historischer Fokus}         & Aristoteles, Friedrich Nietzsche\\
                                       & \\
   \textsc{Bevorzugte Werkzeuge}       & \LaTeX, Zotero, LimeSurvey, Python, R, Git
\end{longtable}
...
%%%%%%%%%%%%%%
\clearpage
\section{Anstellung und akademische Stationen}
\begin{longtable}{p{2.5cm}p{11cm}}
\multirow{3}{2.5cm}{\footnotesize{09/2025\,--\,10/2025}} & Gastwissenschaftler\\
& \textsc{Universität Zürich}\\
& \footnotesize{am Institut für Philosophie bei Pascale Willemsen}\\
\\
\multirow{3}{2.5cm}{\footnotesize{06/2018\,--\,06/2022\\10/2022\,--\,04/2027}} & Wissenschaftlicher Mitarbeiter\\
...
\\
\multirow{3}{2.5cm}{\footnotesize{08/2017\,--\,12/2017}} & Wissenschaftlicher Mitarbeiter\\
...
\\
\multirow{3}{2.5cm}{\footnotesize{04/2017\,--\,03/2018\\10/2018\,--\,03/2020\\10/2022\,--\,03/2023\\10/2023\,--\,09/2024}} & Lehrbeauftragter\\
& \textsc{Carl von Ossietzky Universität Oldenburg}\\
& \footnotesize{am Institut für Philosophie; Konzeption und Leitung von Seminaren für Basismodule, Aufbaumodule und Mastermodule der Philosophie sowie für den Professionalisierungsbereich}\\
\\
\multirow{3}{2.5cm}{\footnotesize{02/2015\,--\,06/2018}} & Wissenschaftliche Hilfskraft\\
...
\\
\multirow{3}{2.5cm}{\footnotesize{10/2013\,--\,06/2018}} & Studentische und Wissenschaftliche Hilfskraft\\
& \textsc{Carl von Ossietzky Universität Oldenburg}\\
& \footnotesize{am Institut für Philosophie bei Mark Siebel, Martin Vialon und Michael Städtler sowie am Hannah-Arendt-Zentrum bei Johann Kreuzer; Konzeption und Leitung von Tutorien in der Theoretischen und der Praktischen Philosophie sowie Organisation und Durchführung von dazugehörigen Prüfungen, Konzeption, Organisation und Leitung von Übungen zur Einführung in das wissenschaftliche Arbeiten, Organisation und Durchführung eines Workshops sowie einer Fachtagung, Mitarbeit im Teilprojekt \enquote{Maße der Bedarfsgerechtigkeit, Expertise und Kohärenz} der Forschungsgruppe \enquote{Bedarfsgerechtigkeit und Verteilungsprozeduren} (FOR 2104) der Deutschen Forschungsgemeinschaft (DFG)}\\
\\
\multirow{3}{2.5cm}{\footnotesize{04/2012\,--\,06/2013}} & Studentische Hilfskraft\\
...
\section{Ausbildung}
\begin{longtable}{p{2.5cm}p{11cm}}
\multirow{3}{2.5cm}{\footnotesize{04/2017\,--\,02/2024}} & Doctor philosophiae (Philosophie)\\
& \textsc{Carl von Ossietzky Universität Oldenburg}\\
...
\\
\multirow{3}{2.5cm}{\footnotesize{04/2014\,--\,03/2017}} & Master of Arts (Philosophie)\\
& \textsc{Carl von Ossietzky Universität Oldenburg}\\
...
\\
\multirow{3}{2.5cm}{\footnotesize{10/2010\,--\,03/2014}} & Bachelor of Arts (Politik-Wirtschaft und Philosophie)\\
& \textsc{Carl von Ossietzky Universität Oldenburg}\\
...
\\
\multirow{3}{2.5cm}{\footnotesize{08/2007\,--\,06/2010}} & Abitur\\
...
\\
\multirow{3}{2.5cm}{\footnotesize{08/2004\,--\,06/2007}} & Erweiterter Sekundarabschluss I\\
...
% IN BEGUTACHTUNG %
%%%%%%%%%%%%%%%%%%%
\subsection*{Publikationen in Begutachtung}
\begin{literature}
\lititem Gahtan, Jamie; Bauer, Alexander Max; Bäker, Neele; Eilts, Jule; Wilke, Jessica (in Überarbeitung für \textit{Current Psychology}): \enquote{Moral Self and Socioeconomic Profiles in Middle Childhood. Examining the Links to Self-Esteem, Prosocial Behavior, and Aggressive Behavior in a Cluster-Analytic Study}.

\lititem Schippers, Michael; Siebel, Mark; Bauer, Alexander Max; Kornmesser, Stephan (in Begutachtung bei \textit{Studia Logica}): \enquote{So Close and Yet So Far. Why Measures of Divergence and Similarity Make Bad Measures of Coherence}.

\lititem Bauer, Alexander Max; Klausner, Lukas Daniel; Menten, Alina; Sturm, Christian (in Begutachtung bei \textit{Paidia – Zeitschrift für Computerspielforschung}): \enquote{Baustelle Jubiläumssammelband. Rückblicke und Reflexionen zur Genese des Sammelbands \enquote{Geisteswissenschaften und Digitale Spiele: Debatten, Data \& Desiderata}}.


%%%%%%%%%%%%%%%%%%%
% IN VORBEREITUNG %
%%%%%%%%%%%%%%%%%%%
\subsection*{Publikationen in Vorbereitung}
\lititem Bauer, Alexander Max; Siebel, Mark (Hrsg.) (in Vorbereitung): \textit{Advances in Experimental Philosophy of Distributive Justice}. London, New York, Oxford, New Delhi und Sydney: Bloomsbury Academic.

\lititem Bauer, Alexander Max; Betzing, David; Birken, Jacob; Hagemann, Simon; Klausner, Lukas Daniel; Menten, Alina; Sturm, Christian; Unterhuber, Tobias (Hrsg.) (in Vorbereitung): \textit{Geisteswissenschaften und Digitale Spiele. Debatten, Data \& Desiderata}. Glückstadt: Verlag Werner Hülsbusch.

\lititem Bauer, Alexander Max; Klausner, Lukas Daniel; Unterhuber, Tobias (in Vorbereitung): \enquote{\enquote{Einhundert Leute haben wir gefragt $\ldots$} Einblicke in Methodenvielfalt und Interdisziplinarität der Game Studies im deutschsprachigen Raum}. In: Bauer, Alexander Max; Betzing, David; Birken, Jacob; Hagemann, Simon; Klausner, Lukas Daniel; Menten, Alina; Sturm, Christian; Unterhuber, Tobias (Hrsg.) (in Vorbereitung): \textit{Geisteswissenschaften und Digitale Spiele. Debatten, Data \& Desiderata}. Glückstadt: Verlag Werner Hülsbusch.

\lititem Bauer, Alexander Max; Hagemann, Simon; Klausner, Lukas Daniel (in Vorbereitung): \enquote{Menschen, Communitys, Dynamiken beobachten.} Ein Gespräch mit Robert Glashüttner über Spielejournalismus zwischen Aufmerksamkeitsökonomie und Kulturkritik«. In: Bauer, Alexander Max; Betzing, David; Birken, Jacob; Hagemann, Simon; Klausner, Lukas Daniel; Menten, Alina; Sturm, Christian; Unterhuber, Tobias (Hrsg.) (in Vorbereitung): \textit{Geisteswissenschaften und Digitale Spiele. Debatten, Data \& Desiderata}. Glückstadt: Verlag Werner Hülsbusch.

\lititem Bauer, Alexander Max; Betzing, David; Birken, Jacob; Hagemann, Simon; Klausner, Lukas Daniel; Menten, Alina; Sturm, Christian; Unterhuber, Tobias (in Vorbereitung): \enquote{Debatten, Data \& Desiderata. Vom Jubiläum zum Sammelband}. In: dies. (Hrsg.): \textit{Geisteswissenschaften und Digitale Spiele. Debatten, Data \& Desiderata}. Glückstadt: Verlag Werner Hülsbusch.

\lititem Bauer, Alexander Max; Klausner, Lukas Daniel (in Vorbereitung): \enquote{\enquote{A Cloak of Letters}. Investigating Philosophical Dialogues in Digital Games Through Planescape: Torment}.
\end{literature}
...
% ZEITSCHRIFTEN %
%%%%%%%%%%%%%%%%%
\subsection*{Zeitschriften und Schwerpunktausgaben}
\begin{literature}
\lititem Bauer, Alexander Max; Ellmers, Sven; Nosthoff, Anna-Verena; Yildirim, Aylin (Hrsg.) (2026): \textit{Oldenburger Philosophische Studien}.
...
\lititem Wilke, Jessica; Bauer, Alexander Max; Bandaru, Yohita Shraddha; Gahtan, Jamie; Bäker, Neele (2026): \enquote{Who Deserves What -- and Why? A Systematic Review and Meta-Analysis on Distributive Justice Preferences and Low Socioeconomic Backgrounds in Children and Adolescents}. \textit{Current Research in Ecological and Social Psychology} 10, 100277. (begutachtet)

\lititem Henne, Paul; Pedryc, Wiktoria; Deichen, Benjamin; Bauer, Alexander Max; Sankner, Annika; Varghese, Saniya; Moonlight, Isaiah (2025): \enquote{The Kraemer Effect Reconsidered}. \textit{New Ideas in Psychology} 80, 101209. (begutachtet)

\lititem Bauer, Alexander Max; Diederich, Adele; Traub, Stefan; Weiss, Arne Robert (2025): \enquote{Thinking About Need. A Vignette Experiment on Need-Based Distributive Justice}. \textit{The Journal of Economic Inequality}. (begutachtet)
...
\begin{literature}
\lititem Beaucamp, Eduard (2017): \textit{Im Spiegel der Geschichte. Die Leipziger Schule der Malerei}. Hrsg. von Bormuth, Matthias; Hüttel, Richard; Triegel, Michael. Red. von Unverzagt, Malte Maria; Bauer, Alexander Max; Bormuth, Matthias. Göttingen: Wallstein.
\end{literature}
...
& \footnotesize{Vortrag auf dem 2. Treffen der Society for Philosophy of Causation an der Universität Göttingen; auf Einladung von Tom Wysocki}\\
\\
...
& \footnotesize{Vortrag auf der 5. European Experimental Philosophy Conference an der University of East Anglia}\\
\\
\multirow{2}{2.5cm}{\footnotesize{20/06/2025}} & The Kraemer Effect Reconsidered\\
& \footnotesize{Poster auf dem 51. Annual Meeting of the Society for Philosophy \& Psychology an der Cornell University; zusammen mit Paul Henne, Wiktoria Pedryc, Benjamin Deichen, Annika Sankner, Saniya Varghese und Isaiah Moonlight}\\
\\
...
& \footnotesize{Vortrag auf der 3. European Experimental Philosophy Conference an der Universität Zürich; online aufgrund von Finanzierungsproblemen}\\
\\
...
& \footnotesize{Vortrag auf dem 25. Kongress der Deutschen Gesellschaft für Philosophie (DGPhil) an der Friedrich-Alexander University Erlangen-Nürnberg; online aufgrund der Pandemie}\\
\\
...
& \footnotesize{Poster auf der Subjective Probability, Utility, and Decision Making Conference an der University of Warwick; zusammen mit Marc Wyszynski; online aufgrund der Pandemie}\\
\\
...
& \footnotesize{Vortrag angenommen für die 18. Biennial Conference of the International Society for Justice Research an der Católica Lisbon School of Business \& Economics; nicht gehalten aufgrund unvorhergesehener Umstände}\\
\\
\\ % tmp %
...
& \footnotesize{Poster mit Kurzvortrag auf der 1. European Experimental Philosophy Conference an der Univerzita Karlova in Prag; zusammen mit Stephan Kornmesser; online aufgrund der Pandemie}\\
\\
...
& \footnotesize{Vortrag angenommen für die 8. Tagung für ​Praktische Philosophie an der Universität Salzburg; zusammen mit Malte Ingo Meyerhuber und Jan Romann; nicht stattgefunden aufgrund der Pandemie}\\
\\
\multirow{2}{2.5cm}{\footnotesize{24/07/2020}} & Need and Responsibility\\
& \footnotesize{Vortrag auf der Konferenz der Society for the Advancement of Behavioral Economics an der National Research University, Higher School of Economics in Moskau; online aufgrund der Pandemie}\\
\\
...
& \footnotesize{Vortrag auf der 1. European Experimental Philosophy Conference an der Univerzita Karlova in Prag; online aufgrund der Pandemie}\\
\\
...
& \footnotesize{Vortrag angenommen für die 20. International Conference on Moral and Political Philosophy an der Universitat de les Illes Balears in Palma; nicht stattgefunden aufgrund der Pandemie}\\
\\
...
& \footnotesize{Vortrag auf der Online-Jubiläumstagung \enquote{Spielkulturen} des AKGWDS; zusammen mit Lukas Daniel Klausner und Christian Sturm}\\
\\
\multirow{2}{2.5cm}{\footnotesize{03/10/2025}} & Distributive Justice and Reference Points Revisited\\
& \footnotesize{Vortrag auf dem Lab Meeting der Experimental Philosophy Group an der Universität Zürich}\\
\\
\multirow{2}{2.5cm}{\footnotesize{03/06/2025}} & Distributive Justice and Reference Points\\
& \footnotesize{Vortrag auf dem Lab Meeting der Experimental Philosophy Group an der Universität Zürich; online}\\
\\
\multirow{2}{2.5cm}{\footnotesize{14/02/2024}} & Empirische Studien zu Fragen der Bedarfsgerechtigkeit\\
& \footnotesize{Disputation im Promotionsverfahren an der Carl von Ossietzky Universität Oldenburg}\\
\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{12/02/2016}} & Entwicklung eines empirisch gestützten Maßes der Bedarfsgerechtigkeit -- Ein axiomatischer Ansatz\\
...
& \footnotesize{Vortrag in Mark Siebels Kolloquium für Abschlussarbeiten an der Carl von Ossietzky Universität Oldenburg}\\
\end{longtable}
...
\begin{longtable}{p{2.5cm}p{11cm}}
\multirow{3}{2.5cm}{\footnotesize{Winter 2026/2027}} & Greifswald Oldenburg Lectures\\
& \footnotesize{Ringvorlesung an der Universität Greifswald und der Carl von Ossietzky Universität Oldenburg; zusammen mit Gregor Damschen und Mark Siebel}\\
\\
\multirow{3}{2.5cm}{\footnotesize{Winter 2026/2027}} & Topics in the Cognitive Sciences of Morality\\
& \footnotesize{Ringvorlesung an der Universität Zürich und der Carl von Ossietzky Universität Oldenburg; zusammen mit Pascale Willemsen; zugleich Seminar an der Carl von Ossietzky Universität Oldenburg}\\
\\
\multirow{3}{2.5cm}{\footnotesize{Summer 2026}} & Wege in den Beruf -- Außerschulische Perspektiven für Geistes-, Sprach- und Kulturwissenschaftler*innen\\
& \footnotesize{Ringvorlesung an der Carl von Ossietzky Universität Oldenburg; zusammen mit Friederike Nastold}\\
& \footnotesize{mit Beiträgen von Lennert Brinkhoff, Monika Eden, Solveig Elias, Nicole Griese, Holger Leerhoff, Hilke Lüschen, Jonas Schoster und Thomas Wachtendorf }\\
\\
\multirow{3}{2.5cm}{\footnotesize{SoSe 2022\\WiSe 2022/2023\\SoSe 2023\\WiSe 2023/2024\\SoSe 2024\\WiSe 2024/2025}} & Philosophisches Kolloquium\\
& \footnotesize{Kolloquium des Instituts für Philosophie an der Carl von Ossietzky Universität Oldenburg; zusammen mit Matthias Bormuth (WiSe 2024/2025), Helena Esther Grass (SoSe 2022), Malte Maria Unverzagt (WiSe 2024/2025), Tilo Wesche (SoSe 2022 -- WiSe 2024/2025) und Gesa Wellmann (SoSe 2023 -- WiSe 2024/2025)}\\
...
\\
\multirow{3}{2.5cm}{\footnotesize{SoSe 2021}} & Nur Fußnoten zu Platon?\\
& \footnotesize{Ringvorlesung an der Carl von Ossietzky Universität Oldenburg; zusammen mit Gregor Damschen, Stephan Kornmesser und Mark Siebel}\\
& \footnotesize{mit Beiträgen von Rafael Ferber, Jörg Hardy, Christoph Helmig, Joachim Horvath, Mark Textor und Emanuel Viebahn}\\
\\
\multirow{3}{2.5cm}{\footnotesize{WiSe 2019/2020}} & Paradoxien\\
& \footnotesize{Ringvorlesung an der Carl von Ossietzky Universität Oldenburg; zusammen mit Gregor Damschen und Mark Siebel}\\
& \footnotesize{mit Beiträgen von Inga Bones, Elke Brendel, Gregor Damschen, Guido Kreis, Paul Näger, Mark Siebel, Norman Sieroka und Stefan Uppenkamp}\\
\\
...
\subsection*{Seminare}
\begin{longtable}{p{2.5cm}p{11cm}}
\multirow{2}{2.5cm}{\footnotesize{WiSe 2026/2027}} & Topics in the Cognitive Sciences of Morality\\
& \footnotesize{Seminar an der Carl von Ossietzky Universität Oldenburg für Mastermodule der Philosophie; zugleich Ringvorlesung}\\
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2025/2026}} & Forschungsorientierte Einführung in die Experimentelle Philosophie,\\&Seminar 2\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2025/2026}} & Forschungsorientierte Einführung in die Experimentelle Philosophie,\\&Seminar 1\\
& \footnotesize{Seminar an der Carl von Ossietzky Universität Oldenburg für Vertiefungsmodule und Mastermodule der Philosophie; zusammen mit Stephan Kornmesser}\\
\\
\multirow{2}{2.5cm}{\footnotesize{SoSe 2024}} & Forschungsorientierte Einführung in die Experimentelle Philosophie\\
& \footnotesize{Seminar an der Carl von Ossietzky Universität Oldenburg für Vertiefungsmodule und Mastermodule der Philosophie; zusammen mit Stephan Kornmesser}\\
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2023/2024}} & Einführung in die Experimentelle Theoretische Philosophie\\
& \footnotesize{Seminar an der Carl von Ossietzky Universität Oldenburg für Basismodule der Philosophie}\\
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2022/2023\\ und SoSe 2023\\WiSe 2023/2024\\ und SoSe 2024\\WiSe 2024/2025\\und SoSe 2025}} & Aristoteles' \enquote{Metaphysik}\\
...
\\
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2022/2023}} & Gedankenexperimente in der Philosophie\\
& \footnotesize{Seminar an der Carl von Ossietzky Universität Oldenburg für Basismodule der Philosophie}\\
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2020/2021}} & Einführung in die Experimentelle Philosophie\\
& \footnotesize{Seminar an der Carl von Ossietzky Universität Oldenburg für Basismodule und Aufbaumodule der Philosophie sowie für den Professionalisierungsbereich; online aufgrund der Pandemie}\\
\\
\multirow{2}{2.5cm}{\footnotesize{SoSe 2020}} & Reichtum als moralisches Problem\\
& \footnotesize{Seminar an der Carl von Ossietzky Universität Oldenburg für Basismodule, Aufbaumodule und Mastermodule der Philosophie sowie für den Professionalisierungsbereich; online aufgrund der Pandemie}\\
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2019/2020}} & Ein Gestirn, auf dem kluge Tiere das Erkennen erfanden -- Sprache und Erkenntnis in den frühen Schriften Nietzsches\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{SoSe 2019}} & Suffizientarismus -- Zu einer Kritik der Unersättlichkeit\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2018/2019}} & Sein und Sollen -- Abgründe und Brücken zwischen empirischer Forschung und normativer Theorie\\
& \footnotesize{Seminar an der Carl von Ossietzky Universität Oldenburg für Basismodule und Aufbaumodule der Philosophie sowie für den Professionalisierungsbereich}\\
\\
\\ % tmp %
\\ % tmp %
\multirow{2}{2.5cm}{\footnotesize{WiSe 2017/2018}} & Eduard Beaucamp und die Leipziger Schule -- Ästhetik zwischen Kontinuität und Bruch\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{SoSe 2017}} & Operationalisierung von Verteilungsgerechtigkeit -- Zur Grundlegung der Messbarkeit von Gerechtigkeit zwischen normativer Theorie und formaler Modellierung\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2015/2016}} & Nietzsche -- Frühe Schriften\\
...
\subsection*{Tutorien}
\begin{longtable}{p{2.5cm}p{11cm}}
\multirow{2}{2.5cm}{\footnotesize{SoSe 2014\\SoSe 2015}} & Einführung in die Praktische Philosophie\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2012/2013\\WiSe 2013/2014\\WiSe 2014/2015\\WiSe 2015/2016\\WiSe 2016/2017}} & Einführung in die Theoretische Philosophie\\
...
% AUSSERCURRICULARES %
%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Außercurriculares}
\begin{longtable}{p{2.5cm}p{11cm}}
\multirow{2}{2.5cm}{\footnotesize{WiSe 2022/2023\\SoSe 2023\\WiSe 2023/2024\\SoSe 2024\\WiSe 2024/2025\\SoSe 2025\\WiSe 2025/2026\\WiSe 2026/2027}} & Nach dem Studium promovieren?!\\
& \footnotesize{Mentor im Programm \enquote{Nach dem Studium promovieren?!} der Graduiertenschule für Gesellschafts- und Geisteswissenschaften (3GO) der Carl von Ossietzky Universität Oldenburg}\\
\\
\\
\\
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2018/2019\\SoSe 2019\\WiSe 2019/2020\\SoSe 2020\\WiSe 2020/2021\\SoSe 2021\\WiSe 2021/2022\\SoSe 2022}} & Schreibbegleitung für Haus- und Abschlussarbeiten\\
& \footnotesize{Mentor im Programm \enquote{Schreibbegleitung für Haus- und Abschlussarbeiten} der Graduiertenschule für Gesellschafts- und Geisteswissenschaften (3GO) der Carl von Ossietzky Universität Oldenburg}\\
\\
\\
\\
\\
\multirow{2}{2.5cm}{\footnotesize{WiSe 2013/2014\\WiSe 2014/2015\\WiSe 2015/2016\\WiSe 2016/2017\\WiSe 2017/2018\\WiSe 2018/2019}} & Einführung in das wissenschaftliche Arbeiten\\
...
% LEHRKONZEPTE %
%%%%%%%%%%%%%%%%
\subsection*{Lehrkonzepte}
\begin{literature}
\lititem Bauer, Alexander Max; Kornmesser, Stephan (2025): \textit{Forschungsorientierte Einführung in die Experimentelle Philosophie}. Oldenburg: Carl von Ossietzky Universität Oldenburg.
\end{literature}
...
\begin{literature}
\lititem Wienekamp, Saskia (in Arbeit): \textit{Die Ethik der Künstlichen Intelligenz. Moralische Entscheidungsfindung und Verantwortung in autonomen Systemen} (Masterarbeit an der Carl von Ossietzky Universität Oldenburg; Zweitprüferin: Susanne Möbuß)

\lititem Maler, Henrik (in Arbeit): \textit{Ästhetik und Existenz. Karl Jaspers' Ästhetik-Begriff im Lichte von Walter Paters Ästhetizismus} (Masterarbeit an der Carl von Ossietzky Universität Oldenburg; Erstprüferin: Susanne Möbuß)

\lititem Reinken, Svea (in Arbeit): \textit{Lügen, Irreführungen und die Frage um die Täuschungsabsicht. Eine Untersuchung mit Mitteln der Experimentellen Philosophie} (Masterarbeit an der Carl von Ossietzky Universität Oldenburg; Erstprüfer: Mark Siebel)

\lititem Schaaf, Tristan (2026): \textit{Inwiefern lässt sich der Tod als Gegenstand gerechter Verteilung begreifen und wie gehen unterschiedliche Gerechtigkeitstheorien mit Ungleichheiten von Todesrisiken um?} (Bachelorarbeit an der Carl von Ossietzky Universität Oldenburg; Erstprüfer: Mark Siebel)

\lititem Joshua Krüger (2026): \textit{Roll for Mortality. \textit{Dungeons \& Dragons} as a Framework for Processing Death. Exploring How Gameplay Encourages Existential Processing} (Bachelorarbeit an der Carl von Ossietzky Universität Oldenburg; Zweitprüfer: Mark Siebel)

\lititem Heinks, Ellen (2026): \textit{Aristoteles' Konzept der Tugendfreundschaft. Eine Analyse anhand des Films \textit{Ziemlich beste Freunde}} (Bachelorarbeit an der Carl von Ossietzky Universität Oldenburg; Zweitprüferin: Susanne Möbuß)

\lititem Lian, Jessica Xinyi (2026): \textit{Does Immortality Bring Us Meaning in Life? Criteria for a Fulfilling Everlasting Life With \textit{Frieren: Beyond a Journey's End} as an Example} (Bachelorarbeit an der Carl von Ossietzky Universität Oldenburg; Erstprüfer: Paul Blattner)

\lititem Jahnel, Niklas (2026): \textit{Nihilismus, Moral und Glaube. Ein interdisziplinärer Ansatz} (Masterarbeit an der Carl von Ossietzky Universität Oldenburg; Erstprüferin: Susanne Möbuß)

\lititem Saylam, Esma (2026): \textit{Die Auseinandersetzung mit dem Tod durch philosophisches Denken. Eine Herangehensweise anhand des Bilderbuchs \textit{Von Larven und Libellen} von Gesa Rensmann} (Bachelorarbeit an der Carl von Ossietzky Universität Oldenburg; Erstprüfer: Paul Blattner)

\lititem Saylam, Esma (2025): \textit{Die Auseinandersetzung mit dem Tod durch philosophisches Denken. Eine Herangehensweise anhand des Bilderbuchs \enquote{Von Larven und Libellen} von Gesa Rensmann} (Bachelorarbeit an der Carl von Ossietzky Universität Oldenburg; Erstprüfer: Paul Blattner)

\lititem Jahnel, Niklas (2025): \textit{Nihilismus, Moral und Glaube. Ein interdisziplinärer Ansatz} (Masterarbeit an der Carl von Ossietzky Universität Oldenburg; Erstprüferin: Susanne Möbuß)
...
\section{Gremien}
\begin{longtable}{p{2.5cm}p{11cm}}
\multirow{2}{2.5cm}{\footnotesize{04/2019\,--\,04/2020}} & Promovierendenvertreter\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{seit\\04/2019}} & Stellvertretender Mittelbauvertreter\\
& \footnotesize{Vertretung des Mittelbaus im Institutsrat des Instituts für Philosophie der Carl von Ossietzky Universität Oldenburg; Mittelbauvertreter im Prüfungsausschuss für den Fachmaster Philosophie}\\
\\
\multirow{2}{2.5cm}{\footnotesize{05/2018\,--\,04/2023}} & Promovierendenvertreter\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{04/2017\,--\,04/2018}} & Stellvertretender Promovierendenvertreter\\
& \footnotesize{Vertretung der Promovierenden der Fakultät IV im Direktorium der Graduiertenschule für Gesellschafts- und Geisteswissenschaften (3GO) an der Carl von Ossietzky Universität Oldenburg}\\
\\
\multirow{2}{2.5cm}{\footnotesize{04/2017\,--\,03/2018}} & Stellvertretender Studierendenvertreter\\
...
\begin{itemize}
   ...
   \item PLOS ONE (2026)
   \item Systems Research and Behavioral Science (2025)
...
\begin{longtable}{p{2.5cm}p{11cm}}
\multirow{2}{2.5cm}{\footnotesize{2024}} & Preis der Lehre in der Kategorie Forschendes Lernen\\
...
\\
\multirow{2}{2.5cm}{\footnotesize{2015/2016}} & Deutschlandstipendium\\
& \footnotesize{von der Carl von Ossietzky Universität Oldenburg für herausragende Leistungen im Studium}\\
\\
\multirow{2}{2.5cm}{\footnotesize{2014/2015}} & Deutschlandstipendium\\
& \footnotesize{von der Carl von Ossietzky Universität Oldenburg für herausragende Leistungen im Studium}\\
\end{longtable}
...
\begin{itemize}
   ...
   \item International Society for Moral Psychology (ISMP)
