...
\begin{longtable}{p{4cm}p{11.5cm}}
   \textsc{Spezialisierungsbereiche}   & Experimentelle Philosophie, Bedarfsgerechtigkeit, Kausalität\\
                                       & \\
   \textsc{Kompetenzbereiche}          & Spielwissenschaften, Verteilungsgerechtigkeit,\\ & Wissenschaftsphilosophie, Metaphysik\\
                                          & \\
   \textsc{Interessensbereiche}        & Digitale Geisteswissenschaften, Metaphilosophie,\\ & Sprachphilosophie\\
                                          & \\
